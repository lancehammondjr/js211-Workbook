...
//this is the class of the Crew member
class CrewMember {
  name;
  job;
  specialSkill;
...
class Ship {
  ...
  // this will tell us when there are more crew members to start the mission
  missionStatement() {
    // if there is 0 crew members the mission can not be started
    if (this.crew.length == 0) {
      console.log(`Can't perform a mission yet, because there are only ${this.crew.length} crew members`)
      return "Can't perform a mission yet."
    }
    else {
      console.log(this.ability); 
      return this.ability; // this will return the ship ability like:"Ascend into low orbit"
    }
